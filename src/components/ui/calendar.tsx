...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        // ขนาด: p-2 = padding, [--cell-size:1.75rem] = ขนาดของแต่ละช่อง (เดิม 2rem)
      ...
      classNames={{
        ...
        months: cn(
          // gap-3 = ระยะห่างระหว่าง 2 เดือน (เดิม gap-4)
          "relative flex flex-col gap-3 md:flex-row",
          defaultClassNames.months
        ),
        month: cn(
          // gap-2 = ระยะห่างระหว่าง header กับตาราง (เดิม gap-4)
        ...
        week_number: cn(
          // text-[0.7rem] = ขนาดตัวอักษรเลขสัปดาห์ (เดิม 0.8rem)
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          // size-3.5 = ขนาดไอคอนลูกศร (เดิม size-4)
          if (orientation === "left") {
            return (
