...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      ...
      {/* Data Deletion */}
      <Card id="data-deletion">
        <CardHeader>
          <div className="flex items-center space-x-3">
            <FileText className="h-6 w-6 text-primary" />
            <div>
              <CardTitle>การลบข้อมูล (Data Deletion)</CardTitle>
              <CardDescription>วิธีการขอลบข้อมูลส่วนบุคคลของคุณ</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            <div className="space-y-4">
              <h4 className="font-semibold text-primary">สิทธิในการลบข้อมูล</h4>
              <p className="text-sm text-muted-foreground">
                คุณมีสิทธิในการขอให้เราลบข้อมูลส่วนบุคคลของคุณ รวมถึงข้อมูลที่ได้จาก Facebook Login
              </p>
            </div>

            <div className="space-y-4">
              <h4 className="font-semibold text-primary">วิธีการขอลบข้อมูล</h4>
              <div className="space-y-3">
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h5 className="font-medium mb-2">สำหรับผู้ใช้ Facebook Login:</h5>
                  <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                    <li>ไปที่ Facebook Settings &gt; Apps and Websites</li>
                    <li>ค้นหา "ads169th System"</li>
                    <li>คลิก "Remove" หรือ "Remove App"</li>
                    <li>ข้อมูลของคุณจะถูกลบโดยอัตโนมัติใน 30 วัน</li>
                  </ol>
                </div>
                
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h5 className="font-medium mb-2">สำหรับผู้ใช้ทั่วไป:</h5>
                  <p className="text-sm text-muted-foreground">
                    ส่งอีเมลขอลบข้อมูลไปที่: 
                    <a href="mailto:privacy@ads169th.com" className="text-primary hover:underline ml-1">
            ...
            <div className="space-y-4">
              <h4 className="font-semibold text-primary">ระยะเวลาการลบข้อมูล</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <h5 className="font-medium">ข้อมูลทั่วไป</h5>
                  <p className="text-sm text-muted-foreground">ลบภายใน 30 วัน</p>
                </div>
                <div className="space-y-2">
                  <h5 className="font-medium">Log และ Backup</h5>
                  <p className="text-sm text-muted-foreground">ลบภายใน 90 วัน</p>
                </div>
              </div>
            </div>

            <div className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg">
              <h5 className="font-medium text-blue-900 dark:text-blue-100 mb-2">หมายเหตุ:</h5>
              <p className="text-sm text-blue-700 dark:text-blue-300">
                ข้อมูลบางประเภทอาจถูกเก็บไว้ตามกฎหมายหรือเพื่อความปลอดภัย 
                เช่น logs การเข้าถึงระบบ (เก็บไว้ 1 ปีตามนโยบายความปลอดภัย)
              </p>
            </div>
          </div>
        </CardContent>
